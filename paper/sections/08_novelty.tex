...
\begin{figure}[htbp]
    ...
    \caption{Runtime monkey-patch from whitelist skills injects tote-aware grasp/lift checks. This is complementary to---not a substitute for---backend/robot runtime fixes required for stable official-score regeneration. See limitations for compliance disclosure.}
