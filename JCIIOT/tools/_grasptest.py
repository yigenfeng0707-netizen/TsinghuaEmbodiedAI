...
c=d.Dswhub()
c.s.put(d.BASE+"/api/contents/_grasptest.py", json={"type":"file","format":"text","content":INNER}, timeout=30)
print(c.run_python(
"import subprocess,os\n"
"env={**os.environ,'MUJOCO_GL':'osmesa','PYOPENGL_PLATFORM':'osmesa','GATE_OLLAMA':'false'}\n"
"p=subprocess.Popen(['python','/mnt/workspace/_grasptest.py'],stdout=open('/mnt/workspace/_grasptest.log','w'),stderr=subprocess.STDOUT,env=env)\n"
