...
# container (L1,L4) offset 0.65; tote (L2,L3,L5) offset 0.8
level_offset = {"L1":0.65, "L2":0.8, "L3":0.8, "L4":0.65, "L5":0.8}
poses_by_level = {}
...
log("updated grasp_poses_by_level with offset 0.8 for tote")
log("DONE")
'''

c=d.Dswhub()
c.s.put(d.BASE+"/api/contents/_fix_poses4.py", json={"type":"file","format":"text","content":INNER}, timeout=30)
print(c.run_python(
"import subprocess,os\n"
"env={**os.environ,'MUJOCO_GL':'osmesa','PYOPENGL_PLATFORM':'osmesa'}\n"
"p=subprocess.Popen(['python','/mnt/workspace/_fix_poses4.py'],stdout=open('/mnt/workspace/_fix_poses4.log','w'),stderr=subprocess.STDOUT,env=env)\n"
